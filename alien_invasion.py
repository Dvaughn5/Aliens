...
class AlienInvasion:
	...
	def __init__(self):
		...
		self.sb = Scoreboard(self) # Create an instance of the scoreboard
	...
	def _check_play_button(self, mouse_pos):
		# Starting a new game if the player clicks the play button
		...
		if button_clicked and not self.stats.game_active:
			...
			# Create a new fleet and center the ship at the start of every game
			self._create_fleet()
			self.ship.center_ship()

			# Hiding the mouse cursor once the game is active 
	...
	def _ship_hit(self):
		...
		if self.stats.ships_left > 0:
			# Decrement ship count, and scoreboard once hit
